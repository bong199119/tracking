...
class_dict={
    0 : 'Obturator (OBTL-UCUK)',
    1 : 'Trocar (TRCL-UCUK)',
    2 : 'Ligasure (COVIDIEN) (LGSL-MACV)',
    3 : 'Graspers',
    4 : 'Polymer Clip Applier (CLAL-UCUK)',
    5 : 'Dissector',
    6 : 'Gauze (GAUL-UCUK)',
    7 : 'Linear Stapler',
    8 : 'Needle Holder (AESCULAP) (NDHL-UCAE)',
    9 : 'Specimen Retrieval Bag (RTBL-UCUK)',
    10 : 'Suction Irrigator',
    11 : 'Drain (JPCL-UCUK)',
    }

...
model = YOLO('/home/yolo_test/workspace/object_detection/yolov8/models/best_4thdataset.pt')  # pretrained YOLOv8n model
video_folder_path = r'/home/yolo_test/workspace/object_detection/yolov8/videos/for_trackingsample'
